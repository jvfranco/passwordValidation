...
class LowerValidationTest {
    ...
    @BeforeEach
    void setUp() {
        this.lowerValidation = new LowerValidation(this.validationStep);
    }

    @Test
    @DisplayName("Must contain lowercase letters")
    void executeSuccessTest() {
        ...
        this.lowerValidation.execute(password);
    ...
    void mustThrowExceptionTest() {
        ...
        assertThrows(ValidatorException.class, () -> this.lowerValidation.execute(password));
